...
namespace IEMod.Mods.ConsoleMod {
	...
	public class mod_UIConsole : UIConsole
	{
		...
		private void mod_AdjustBackground(Vector2 delta)
		{
            //ORIGINAL CODE
			...
			//FOLLOWING BLOCK IS A REWRITE OF A SECTION OF THE ORIGINAL. PURPOSE OF REWRITE UNKNOWN
			...
			{
                //RESUME ORIGINAL CODE TO END OF FUNCTION
